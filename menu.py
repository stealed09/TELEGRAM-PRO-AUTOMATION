...
class MenuUI:
    ...
    @staticmethod
    def scraper_menu():
        """Scraper menu — updated with new options"""
        keyboard = [
            [InlineKeyboardButton("👥 Scrape Members (Full List)", callback_data="scrape_members")],
            [InlineKeyboardButton("🎯 Scrape Active Users (Recent Msgs)", callback_data="scrape_active")],
            [InlineKeyboardButton("➕ Add Scraped Users to Group", callback_data="add_to_group")],
            [InlineKeyboardButton("📁 Add Users from File", callback_data="add_from_file")],
            [InlineKeyboardButton("📨 Message Scraped Users", callback_data="blast_message")],
            [InlineKeyboardButton("📨 Message History Users Only", callback_data="blast_history")],
            [InlineKeyboardButton("📁 Message Users from File", callback_data="blast_from_file")],
            [InlineKeyboardButton("« Back", callback_data="main_menu")]
        ]
        return InlineKeyboardMarkup(keyboard)

    @staticmethod
    def scraper_action_menu():
        """After scrape — quick action buttons"""
        keyboard = [
            [InlineKeyboardButton("➕ Add All to Group", callback_data="add_to_group")],
            [InlineKeyboardButton("📨 Message All", callback_data="blast_message")],
            [InlineKeyboardButton("📨 Message History Only", callback_data="blast_history")],
